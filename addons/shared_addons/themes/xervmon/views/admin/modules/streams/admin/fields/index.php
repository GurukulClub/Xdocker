    ...
    <table class="table table-striped" cellpadding="0" cellspacing="0">
		...
		<?php foreach ($fields as $field):?>
			<tr>
				...
				<td class="actions">
					<?php echo anchor('admin/streams/fields/edit/' . $field->id, lang('streams:edit'), 'class="btn btn-primary"');?> 					
					<?php echo anchor('admin/streams/fields/delete/' . $field->id, lang('streams:delete'), 'class="btn confirm btn btn-danger"'); ?>
				</td>
			</tr>
		<?php endforeach;?>
		</tbody>
