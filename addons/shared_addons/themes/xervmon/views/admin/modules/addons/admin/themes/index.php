		...
		<table class="table table-striped" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td class="actions">
						<?php echo isset($theme->options) ? anchor('admin/addons/themes/options/'.$theme->slug, lang('addons:themes:options'), 'title="'.$theme->name.'" class="btn btn-primary"') : '' ?>
						<a href="<?php echo $theme->screenshot ?>" rel="screenshots" title="<?php echo $theme->name ?>" class="btn"><?php echo lang('buttons:preview') ?></a>
						<?php if($theme->slug != 'admin_theme') { echo anchor('admin/addons/themes/delete/'.$theme->slug, lang('buttons:delete'), 'class="btn btn-danger"'); } ?>
					</td>
				</tr>
				<?php endforeach ?>
			</tbody>
