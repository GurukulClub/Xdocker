...
/* viweport min height for .xervmon-sidebar, .xervmon-mainContent */
!(function ($) {
    function setupMinLayoutHeight() {
        setTimeout(function () {
            $('.xervmon-sidebar, .xervmon-mainContent').css('min-height', $(window).height() * 0.8);
            $('.xervmon-mainContent').css('min-height', $('.xervmon-sidebar').outerHeight() + 20);
            console.log("Recalc content height");
        }, 100);
    }
    $(setupMinLayoutHeight);
    $(window).on("resize", setupMinLayoutHeight);
    $(function () {
        $('.xervmon-sidebar').on("shown", ".collapse", setupMinLayoutHeight).on("click", ".accordion-toggle", setupMinLayoutHeight);
    });
})(jQuery);
...
$.extend($.ui.tabs.prototype, {
    paging: function (z) {
        function r() {
            ...
            s = b.element.width();
            var d = 0;
            b.lis.each(function (a) {
                a == b.options.selected ? (selectedTabWidths[a] = $(this).outerWidth({
                    margin: !0
                }), j[a] = b.lis.eq(a).removeClass("ui-tabs-selected").outerWidth({
                    margin: !0
                }), b.lis.eq(a).addClass("ui-tabs-selected"), d = Math.min(d, Math.abs(selectedTabWidths[a] - j[a]))) : (j[a] = $(this).outerWidth({
                        margin: !0
                    }), selectedTabWidths[a] = b.lis.eq(a).addClass("ui-tabs-selected").outerWidth({
                        margin: !0
                    }),
                    b.lis.eq(a).removeClass("ui-tabs-selected"), d = Math.max(d, Math.abs(selectedTabWidths[a] - j[a])));
                l += j[a]
            });
            l += d + ($.browser.msie ? 4 : 0) + 9;
            if (l > s) {
                li = $("<li></li>").addClass("ui-state-default ui-tabs-paging-next").append($('<a href="#"></a>').click(function () {
                    v("next");
                    return !1
                }).html(e.nextButton));
                b.lis.eq(b.length() - 1).after(li);
                k = li.outerWidth({
                    margin: !0
                });
                li = $("<li></li>").addClass("ui-state-default ui-tabs-paging-prev").append($('<a href="#"></a>').click(function () {
                    v("prev");
                    return !1
                }).html(e.prevButton));
                b.lis.eq(0).before(li);
                k += li.outerWidth({
                    margin: !0
                });
                k += 19;
                for (var g = 0, a = 0, n = 0, h = 0; h < j.length; h++) {
                    if (0 == a || selectedTabWidths[h] - j[h] > n) n = selectedTabWidths[h] - j[h];
                    if (null == f[g]) f[g] = {
                        start: h
                    };
                    else if (0 < h && 0 == h % e.tabsPerPage || j[h] + a + k + 12 > s) a + n > m && (m = a + n), g++, f[g] = {
                        start: h
                    }, a = 0;
                    f[g].end = h + 1;
                    a += j[h];
                    h == b.options.selected && (c = g)
                }
                a + n > m && (m = a + n);
                b.lis.hide().slice(f[c].start, f[c].end).show();
                c == f.length - 1 && !e.cycle && o("next");
                0 == c && !e.cycle && o("prev");
                buttonPadding = s - m - k;
                0 < buttonPadding && $(".ui-tabs-paging-next",
                    b.element).css({
        ...
        function v(d) {
            c += "prev" == d ? -1 : 1;
            if ("prev" == d && 0 > c && e.cycle || "next" == d && c >= f.length && !e.cycle) c = f.length - 1;
            else if ("prev" == d && 0 > c || "next" == d && c >= f.length && e.cycle) c = 0;
            var g = f[c].start,
                a = f[c].end;
            b.lis.hide().slice(g, a).show();
            "prev" == d ? (t("next"), e.follow && (b.options.selected < g || b.options.selected > a - 1) && b.select(a - 1), !e.cycle && 0 >= g && o("prev")) : (t("prev"), e.follow && (b.options.selected < g || b.options.selected > a -
                1) && b.select(g), !e.cycle && a >= b.length() && o("next"))
        }

        function o(d) {
            $(".ui-tabs-paging-" + d, b.element).addClass("ui-tabs-paging-disabled")
        }

        function t(d) {
            $(".ui-tabs-paging-" + d, b.element).removeClass("ui-tabs-paging-disabled")
        }

        function w() {
            u && clearTimeout(u);
            if (x != $(window).height() || y != $(window).width()) u = setTimeout(A, 100)
        }
        ...
        function p() {
            $(".ui-tabs-paging-next", b.element).remove();
            $(".ui-tabs-paging-prev", b.element).remove();
            b.lis.show();
            q = !1;
            $(window).unbind("resize", w)
        }
        var e = {
            tabsPerPage: 0,
            nextButton: "&#187;",
        ...
        b.add = function (b, c, a) {
            q && p();
            B.apply(this, [b, c, a]);
            e.selectOnAdd && (void 0 == a && (a = this.lis.length - 1), this.select(a));
            r()
        };
        var C = b.remove;
        b.remove = function (b) {
        ...
        b.select = function (d) {
            D.apply(this, [d]);
            if (q && e.followOnSelect)
                for (i in f) {
                    var g =
                        f[i].start,
                        a = f[i].end;
                    if (d >= g && d < a) {
                        i != c && (b.lis.hide().slice(g, a).show(), c = parseInt(i), 0 == c ? (t("next"), !e.cycle && 0 >= g && o("prev")) : (t("prev"), !e.cycle && a >= b.length() && o("next")));
                        break
                    }
                }
        };
