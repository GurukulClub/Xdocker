...
( function(factory) {"use strict";
        ...
        $.widget("mn.sDashboard", {
            ...
            _create : function() {
                console.log("sDashboard", "_create", this);
                this.element.addClass("sDashboard");
                this._createView();

            },
            _setOption : function(key, value) {
                console.log("sDashboard", "_setOption", key, value);
            ...
            _createView : function() {
                ...
                console.log("sDashboard", "_createView", _dashboardData);
                var i;
            ...
            _bindEvents : function() {
                ...
                // widget menu click event handler
                this.element.on("click", ".sDashboardWidgetHeader .js-menu-button", function(e) {
                    var widget = $(e.currentTarget).parents("li:first");
                    var widgetId = widget.attr("id");
                    console.log("sDashboard showing menu for " + widgetId);
                    widget.closest(".sDashboard").trigger("widget-menu.sDashboard", widgetId);
                });
                ...
                this.element.on("click", ".sDashboardWidgetHeader .js-close-button", function(e) {
                    var widget = $(e.currentTarget).parents("li:first");
                    var widgetId = widget.attr("id");
                    console.log("sDashboard removing " + widgetId);
                    var evt = jQuery.Event("widget-close.sDashboard");
                    widget.closest(".sDashboard").trigger(evt, widgetId);
                ...
                this.element.on("click", ".sDashboardWidgetHeader .js-hide-button", function(e) {
                    ...
                    $this.attr('title', 'show').addClass('js-show-button').removeClass('js-hide-button');
                });
                this.element.on("click", ".sDashboardWidgetHeader .js-show-button", function(e) {
                    ...
                    $this.attr('title', 'hide').removeClass('js-show-button').addClass('js-hide-button');
                });
            ...
            _constructWidget : function(widgetDefinition) {
                ...
                if (!widgetDefinition.hasOwnProperty("disableCloseButton") || !widgetDefinition.disableCloseButton) {
                ...
                if (widgetDefinition.hasOwnProperty("enableSettingsButton") && widgetDefinition.enableSettingsButton) {
                    var menuButton = $('<i  title="widget options " class="js-menu-button menuicon pull-right"></i>');
                    //add menuButton
