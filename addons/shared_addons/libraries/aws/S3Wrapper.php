...
final class S3Wrapper extends S3 {
    ...
    private function __getURL($path) {
        ...
        if (!isset($this->url['scheme']) || $this->url['scheme'] !== 'JumbleTale') return $this->url;
...
$existed = in_array("Xervmon", stream_get_wrappers());
if (!$existed) {
    stream_wrapper_register("Xervmon", 'S3Wrapper');
}