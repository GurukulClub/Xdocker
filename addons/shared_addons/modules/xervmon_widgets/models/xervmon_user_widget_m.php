 ...
 */
 ...
 class Xervmon_User_Widget_m extends MY_Model
{
	protected $_table = 'xervmon_user_widgets';
    ...
    public function getWidgetsByTabID($tabID='')
    {
    	return $this->get_multiple_by('tab_id', $tabID);
    }
    public function addWidgetOfType($tabID, $typeID, $widgetTypeDetails)
    {
        $data = new stdClass();
        $data -> tab_id = $tabID;
        $data -> widget_id = $typeID;
        $data -> title = $widgetTypeDetails->title;
        $data -> user_id = $this->current_user->id;
        return $this->insert($data);
    }

    public function setWidgetTitle($id, $value)    {
        return $this->update($id, array("title" => $value));
    }

    public function setWidgetOptions($id, $value)    {
        return $this->update($id, array("options" => $value));
    }
